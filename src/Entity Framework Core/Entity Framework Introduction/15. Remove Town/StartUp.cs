...
{
    using _15._Remove_Town.Data;
    using _15._Remove_Town.Models;
    ...
    public class StartUp
    {
        ...
        public static string RemoveTown(SoftUniContext context)
        {
            ...
            List<Address> addresses = context.Addresses.Where(x => x.TownId == town.TownId).ToList();

            List<Employee> employees = context.Employees.Where(x => addresses.Contains(x.Address)).ToList();
        ...
        {
            List<EmployeeProject> employeeProjects = context.EmployeesProjects.Where(x => x.ProjectId == 2).ToList();
            ...
            List<string> projectsNames = context.Projects.Select(x => x.Name).Take(10).ToList();
